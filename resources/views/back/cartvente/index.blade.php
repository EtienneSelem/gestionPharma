                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @foreach ($contentvt as $item)
                                <tr>
                                <td class="col-md-2">
                                    <form action="{{ route('paniervente.update', $item->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                ...
                                <td><form action="{{ route('paniervente.destroy', $item->id) }}"method="POST">
                                    @csrf
                                    @method('DELETE')
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <a href="{{ route('ventes.create') }}">
                            <input type="text" value="Vendre" class="btn btn-primary">
                        </a>
                    </div>
                    <!-- /.col -->
                    <div class="col-6">
